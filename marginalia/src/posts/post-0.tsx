...
const Light = () => (
  <>
    ...
    <blockquote>
      <p>
        [Claude prompted: What was the specific moment?]
      </p>
    </blockquote>
    <p>
      The specific moment was when I started my new job last month, and we
...
const Medium = () => (
  <>
    ...
    <p>
      ...
      rolling. Setup is a LOT of work, and from what I've done at work, AI
      seemed very competent and efficient at that. I needed a safe
    ...
    <p>
      ...
      fun to provide a slider to let people see different versions of the
      blog post at different levels of AI editing — from my raw,
...
const Heavy = () => (
  <>
    ...
    <p>
      ...
      shot. Over the first few weeks I continually ramped up how much I
      used it in my day-to-day workflow. I knew immediately it was
