...
const STATE_MEDICAID_AGENCY: Record<StateCode, Source> = {
  ...
  AK: { label: 'Alaska DHSS Health Care Services',             url: 'http://dhss.alaska.gov/dhcs/Pages/default.aspx',                                                date: '2026' },
  AZ: { label: 'AHCCCS (AZ Medicaid)',                         url: 'https://www.azahcccs.gov/',                                                                      date: '2026' },
  AR: { label: 'AR DHS Medical Services',                      url: 'https://humanservices.arkansas.gov/divisions-shared-services/medical-services/',                date: '2026' },
  CA: { label: 'Medi-Cal (CA DHCS)',                           url: 'https://www.dhcs.ca.gov/services/medi-cal',                                                       date: '2026' },
  CO: { label: 'CO HCPF (Health First Colorado)',              url: 'https://hcpf.colorado.gov/',                                                                      date: '2026' },
  CT: { label: 'HUSKY Health (CT DSS)',                        url: 'https://portal.ct.gov/dss/health-and-home-care/husky-health-program',                              date: '2026' },
  DE: { label: 'DE DMMA Medicaid',                             url: 'https://dhss.delaware.gov/dhss/dmma/',                                                            date: '2026' },
  FL: { label: 'FL Agency for Health Care Administration',     url: 'https://ahca.myflorida.com/',                                                                     date: '2026' },
  GA: { label: 'GA Medicaid (Dept of Community Health)',       url: 'https://medicaid.georgia.gov',                                                                    date: '2026' },
  HI: { label: 'Med-QUEST (HI DHS)',                           url: 'https://medquest.hawaii.gov/',                                                                    date: '2026' },
  ID: { label: 'ID DHW Medicaid',                              url: 'https://healthandwelfare.idaho.gov/services-programs/medicaid-health',                            date: '2026' },
  IL: { label: 'IL HFS Medical Programs',                      url: 'https://hfs.illinois.gov/medicalclients.html',                                                    date: '2026' },
  ...
  KY: { label: 'KY Medicaid (DMS)',                            url: 'https://www.chfs.ky.gov/agencies/dms/Pages/default.aspx',                                          date: '2026' },
  LA: { label: 'LA Medicaid',                                  url: 'https://www.medicaid.la.gov/',                                                                     date: '2026' },
  ME: { label: 'MaineCare',                                    url: 'https://www.maine.gov/dhhs/ofi/programs-services/mainecare',                                       date: '2026' },
  MD: { label: 'Maryland Medicaid',                            url: 'https://health.maryland.gov/mmcp/Pages/Home.aspx',                                                 date: '2026' },
  MA: { label: 'MassHealth',                                   url: 'https://www.mass.gov/masshealth',                                                                  date: '2026' },
  MI: { label: 'MI MDHHS Medicaid',                            url: 'https://www.michigan.gov/mdhhs/assistance-programs/medicaid',                                      date: '2026' },
  MN: { label: 'MN Health Care Programs (DHS)',                url: 'https://mn.gov/dhs/people-we-serve/adults/health-care/health-care-programs/',                       date: '2026' },
  ...
  MT: { label: 'MT Healthcare Programs (DPHHS)',               url: 'https://dphhs.mt.gov/MontanaHealthcarePrograms',                                                    date: '2026' },
  ...
  NH: { label: 'NH Medicaid (DHHS)',                           url: 'https://www.dhhs.nh.gov/programs-services/medicaid',                                                 date: '2026' },
  NJ: { label: 'NJ FamilyCare',                                url: 'https://www.njfamilycare.org/',                                                                      date: '2026' },
  NM: { label: 'NM HCA Medicaid',                              url: 'https://www.hca.nm.gov/lookingforinformation/medicaid/',                                             date: '2026' },
  NY: { label: 'NY Medicaid (DOH)',                            url: 'https://www.health.ny.gov/health_care/medicaid/',                                                    date: '2026' },
  ...
  OR: { label: 'Oregon Health Plan',                           url: 'https://www.oregon.gov/oha/hsd/ohp/Pages/index.aspx',                                                date: '2026' },
  PA: { label: 'PA DHS Medical Assistance',                    url: 'https://www.dhs.pa.gov/Services/Assistance/Pages/Medical-Assistance-Health-Care.aspx',               date: '2026' },
  RI: { label: 'RI Medicaid (EOHHS)',                          url: 'https://eohhs.ri.gov/consumer/medicaid-information',                                                  date: '2026' },
  ...
  TX: { label: 'TX HHSC Medicaid & CHIP',                      url: 'https://www.hhs.texas.gov/services/health/medicaid-chip',                                              date: '2026' },
  UT: { label: 'UT Medicaid',                                  url: 'https://medicaid.utah.gov/',                                                                            date: '2026' },
  VT: { label: 'Green Mountain Care (VT)',                     url: 'https://www.greenmountaincare.org/',                                                                    date: '2026' },
  VA: { label: 'Cover Virginia / DMAS',                        url: 'https://www.dmas.virginia.gov/',                                                                        date: '2026' },
  WA: { label: 'Apple Health (WA HCA)',                        url: 'https://www.hca.wa.gov/health-care-services-supports/apple-health-medicaid-coverage',                  date: '2026' },
  WV: { label: 'WV Medicaid (BMS)',                            url: 'https://dhhr.wv.gov/bms/',                                                                              date: '2026' },
  WI: { label: 'BadgerCare Plus (WI DHS)',                     url: 'https://www.dhs.wisconsin.gov/badgercareplus/',                                                         date: '2026' },
...
const STATE_CHIP_AGENCY: Record<StateCode, Source> = {
  ...
  AK: { label: 'Denali KidCare (AK CHIP)',                     url: 'http://dhss.alaska.gov/dhcs/Pages/denalikidcare/default.aspx',                                          date: '2026' },
  AZ: { label: 'KidsCare (AHCCCS)',                            url: 'https://www.azahcccs.gov/Members/GetCovered/Categories/kidscare.html',                                  date: '2026' },
  AR: { label: 'ARKids First',                                 url: 'https://humanservices.arkansas.gov/about-dhs/dco/programs-services/arkids-first/',                       date: '2026' },
  CA: { label: 'Medi-Cal for Kids',                            url: 'https://www.dhcs.ca.gov/services/medi-cal',                                                              date: '2026' },
  CO: { label: 'Child Health Plan Plus (CHP+)',                url: 'https://hcpf.colorado.gov/child-health-plan-plus',                                                       date: '2026' },
  CT: { label: 'HUSKY B (CT CHIP)',                            url: 'https://portal.ct.gov/dss/health-and-home-care/husky-health-program',                                    date: '2026' },
  DE: { label: 'Delaware Healthy Children Program',            url: 'https://dhss.delaware.gov/dhss/dhcq/dhcp.html',                                                          date: '2026' },
  FL: { label: 'Florida KidCare',                              url: 'https://www.floridakidcare.org/',                                                                         date: '2026' },
  GA: { label: 'PeachCare for Kids',                           url: 'https://medicaid.georgia.gov/programs/peachcare-kids',                                                    date: '2026' },
  HI: { label: 'Med-QUEST (HI CHIP)',                          url: 'https://medquest.hawaii.gov/',                                                                            date: '2026' },
  ID: { label: 'ID CHIP',                                      url: 'https://healthandwelfare.idaho.gov/services-programs/medicaid-health',                                    date: '2026' },
  IL: { label: 'All Kids (IL)',                                url: 'https://hfs.illinois.gov/medicalclients/allkids.html',                                                    date: '2026' },
  IN: { label: 'Hoosier Healthwise',                           url: 'https://www.in.gov/medicaid/members/health-coverage-programs/programs-by-name/hoosier-healthwise/',       date: '2026' },
  IA: { label: 'Hawki (IA CHIP)',                              url: 'https://hhs.iowa.gov/programs/welcome-iowa-hawki',                                                        date: '2026' },
  ...
  ME: { label: 'CubCare (MaineCare)',                          url: 'https://www.maine.gov/dhhs/ofi/programs-services/mainecare',                                                date: '2026' },
  MD: { label: 'Maryland Children’s Health Program',      url: 'https://health.maryland.gov/mmcp/chp/',                                                                     date: '2026' },
  MA: { label: 'MassHealth (children)',                        url: 'https://www.mass.gov/masshealth',                                                                          date: '2026' },
  MI: { label: 'MIChild',                                      url: 'https://www.michigan.gov/mdhhs/assistance-programs/medicaid/michild',                                       date: '2026' },
  MN: { label: 'MinnesotaCare',                                url: 'https://mn.gov/dhs/people-we-serve/adults/health-care/health-care-programs/programs-and-services/minnesotacare.jsp', date: '2026' },
  MS: { label: 'MS CHIP',                                      url: 'https://medicaid.ms.gov/programs/childrens-health-insurance-program/',                                       date: '2026' },
  MO: { label: 'MO HealthNet for Kids',                        url: 'https://dss.mo.gov/mhd/participants/pages/mhdkids.htm',                                                     date: '2026' },
  MT: { label: 'Healthy Montana Kids',                         url: 'https://dphhs.mt.gov/HealthyMontanaKids',                                                                   date: '2026' },
  NE: { label: 'Kids Connection (NE)',                         url: 'https://dhhs.ne.gov/Pages/Kids-Connection.aspx',                                                            date: '2026' },
  NV: { label: 'Nevada Check Up',                              url: 'https://dwss.nv.gov/Health_Care/Nevada_Check_Up/',                                                          date: '2026' },
  NH: { label: 'NH Healthy Kids',                              url: 'https://www.dhhs.nh.gov/programs-services/medicaid',                                                         date: '2026' },
  NJ: { label: 'NJ FamilyCare (kids)',                         url: 'https://www.njfamilycare.org/',                                                                              date: '2026' },
  NM: { label: 'NM Centennial Care (kids)',                    url: 'https://www.hca.nm.gov/lookingforinformation/medicaid/',                                                     date: '2026' },
  NY: { label: 'Child Health Plus',                            url: 'https://www.health.ny.gov/health_care/child_health_plus/',                                                  date: '2026' },
  NC: { label: 'NC Health Choice for Children',                url: 'https://medicaid.ncdhhs.gov/beneficiaries/health-choice-children',                                          date: '2026' },
  ND: { label: 'Healthy Steps (ND CHIP)',                      url: 'https://www.hhs.nd.gov/medicaid/healthy-steps',                                                              date: '2026' },
  OH: { label: 'Ohio Medicaid for Children',                   url: 'https://medicaid.ohio.gov/families-and-individuals/coverage/coverage-for-children-and-pregnant-women',       date: '2026' },
  OK: { label: 'SoonerCare (OK CHIP)',                         url: 'https://www.okhca.org/',                                                                                     date: '2026' },
  OR: { label: 'Oregon Health Plan (kids)',                    url: 'https://www.oregon.gov/oha/hsd/ohp/Pages/index.aspx',                                                        date: '2026' },
  PA: { label: 'PA CHIP',                                      url: 'https://www.chipcoverspakids.com/',                                                                           date: '2026' },
  RI: { label: 'RIte Care (RI Medicaid for kids)',             url: 'https://eohhs.ri.gov/consumer/medicaid-information',                                                          date: '2026' },
  ...
  TN: { label: 'CoverKids',                                    url: 'https://www.tn.gov/tenncare/members-applicants/coverkids.html',                                                date: '2026' },
  TX: { label: 'Texas CHIP',                                   url: 'https://www.hhs.texas.gov/services/health/medicaid-chip/programs/childrens-health-insurance-program-chip',     date: '2026' },
  ...
  VA: { label: 'FAMIS (VA CHIP)',                              url: 'https://coverva.dmas.virginia.gov/learn/programs/famis',                                                       date: '2026' },
  WA: { label: 'Apple Health for Kids',                        url: 'https://www.hca.wa.gov/health-care-services-supports/apple-health-medicaid-coverage/free-or-low-cost-health-care', date: '2026' },
  WV: { label: 'WVCHIP',                                       url: 'https://chip.wv.gov/',                                                                                          date: '2026' },
  WI: { label: 'BadgerCare Plus (WI, kids)',                   url: 'https://www.dhs.wisconsin.gov/badgercareplus/',                                                                  date: '2026' },
  WY: { label: 'Kid Care CHIP',                                url: 'https://health.wyo.gov/healthcarefin/kidcare/',                                                                  date: '2026' },
  DC: { label: 'DC Healthy Families',                          url: 'https://dhcf.dc.gov/page/dc-healthy-families',                                                                   date: '2026' },
};
