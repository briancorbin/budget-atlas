...
export function Masthead() {
  return (
    <div style={{
      ...
      paddingTop: 18, paddingBottom: 24, marginBottom: 32,
    }}>
      <div style={{
      ...
      <h1 style={{
        ...
        margin: '14px 0 14px', fontStyle: 'italic',
      }}>
        How Americans actually <br/>live on what they earn.
      </h1>
      <div style={{
        fontFamily: fonts.display, fontSize: 18, color: T.inkSoft,
